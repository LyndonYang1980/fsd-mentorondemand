...
values('John', md5('11111111'), 'John@cn.ibm.com', '2', '12345678', '3', 1, 'MENTOR');

insert into mentor(mentor_name, mentor_password, mentor_email, mentor_experience, contact_number, rating, active, role) 
values('Michael', md5('11111111'), 'Michael@cn.ibm.com', '3', '12345678', '4', 1, 'MENTOR');

insert into mentor(mentor_name, mentor_password, mentor_email, mentor_experience, contact_number, rating, active, role) 
values('Jacob', md5('11111111'), 'Jacob@cn.ibm.com', '2', '12345678', '5', 1, 'MENTOR');
